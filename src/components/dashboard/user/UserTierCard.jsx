    ...
    return (
        <div className="rounded-3xl border border-emerald-100 bg-emerald-50/80 p-6 shadow-sm">
            <div className="flex items-start gap-3">
                ...
                <div>
                    <p className="text-sm font-semibold uppercase tracking-[0.25em] text-primary-700">Membership tier</p>
                    <h3 className="mt-3 text-2xl font-extrabold text-primary-800">{tierName}</h3>
                    ...
                    {!!features.length && (
                        <div className="mt-4 space-y-2">
                            {features.slice(0, 3).map((feature) => (
                                <div key={feature} className="flex items-center gap-2 text-sm text-primary-800">
                                    <Sparkles size={14} />
