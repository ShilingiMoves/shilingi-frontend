                        ...
                        <div className="space-y-4">
                            <article className="rounded-[1.45rem] border border-[#bfe2d6] bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-4 space-y-3">
                                    ...
                                    <button type="button" onClick={() => onSelectSection?.('health')} className="inline-flex w-full items-center justify-center gap-2 rounded-[1rem] border border-[#bfe2d6] bg-[#edf8f3] px-4 py-3 text-sm font-semibold text-[#166a55]">
                                        <Sparkles size={15} />
                                        Ask Financial Health For More Tips
                                    </button>
                                </div>
                            </article>
                            ...
                            <article className="rounded-[1.45rem] border border-[#bfe2d6] bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-4 space-y-3">
                                    ...
                                    <ActionCard title="Set up bill reminders" body="Track key bill-like categories such as rent, utilities, and school fees." cta="Manage Bills" onClick={() => setActiveView('bills')} />
                                </div>
                            </article>
                        </div>
                    </section>
                        ...
                        <article className="rounded-[1.5rem] border border-[#bfe2d6] bg-white p-5 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-[1.35rem] font-bold tracking-tight text-slate-950">Upcoming Bills - {currentMonthLabel}</p>
                                </div>
                                <button type="button" onClick={() => onNavigate('budgets')} className="text-sm font-semibold text-[#166a55]">
                                    + Add Bill
                                </button>
                            ...
                            <div className="mt-5 space-y-3">
                                ...
                                {billItems.length ? billItems.map((item, index) => {
                                    ...
                                    <EmptyCard title="No bills yet" body="Create categories like utilities, school fees, insurance, or subscriptions to manage them here." cta="Add Bill" onClick={() => onNavigate('budgets')} />
                                )}
                            </div>
                        </article>
                        ...
                        <div className="space-y-4">
                            <article className="rounded-[1.5rem] border border-[#bfe2d6] bg-white p-5 shadow-sm">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-[1.35rem] font-bold tracking-tight text-slate-950">Bills Optimisation Tips</p>
                                </div>
                            ...
                            <article className="rounded-[1.5rem] border border-[#bfe2d6] bg-white p-5 shadow-sm">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-[1.35rem] font-bold tracking-tight text-slate-950">Monthly Bills Total</p>
                                </div>
                                <div className="mt-4 space-y-3">
